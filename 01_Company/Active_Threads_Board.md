...
| 4 | 社群內容方向＋生產方式 | 候選②④都有真實反應，發現新教訓 | 妹（持續驗收①③） | 候選④「想看下去」(媒介選對)；候選②「看不懂/普通」——診斷出CC混淆畫面品質vs創意成立、且該機制屬「連續即時揭露」型時間結構，靜態並列會劇透，判定媒介失配不是創意失敗，4圖保留不刪 | 候選②待測「加文案」跟「互動版」兩個翻案方案；候選①做demo前先判斷時間結構類型；③仍卡真貓素材 | 見輪值表 | `04_Systems/Warehouse/LEARNINGS.md`(候選②demo揭露兩個新教訓) |
