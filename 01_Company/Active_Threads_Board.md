...
| 4 | 社群內容方向＋生產方式 | 候選④拿到第一個真實反應「想看下去」 | 妹（持續驗收①②③） | 候選④(C跨貼文版)實際做出demo給妹看,反應「想看下去」——round3效果輪班第一筆真實數據，驗證「先選對媒介」規則有效；妹補充新排程規則:同款配方不能連續重複,間隔3個月以上 | ①②③仍是文字storyboard未做demo(③需真貓實拍素材暫緩)；排程規則已記入LEARNINGS.md | 見輪值表 | `04_Systems/Warehouse/LEARNINGS.md`(內容配方不能連續重複)、`round3_visuals/candidate4_c_v2/` |
