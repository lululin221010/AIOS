...
- 參考資料與外部連結整理
- 過往決策的背景說明
- [Content_Pipeline_Status_Overview.md](Content_Pipeline_Status_Overview.md) — 魯魯社群內容管線總覽（Reel素材／語錄圖卡／語錄文字／候選池四條線的方向/做法/材料現況/缺口一次看清楚），開工前先看這裡避免重新爬記憶，2026-09-10建立
- [Content_Quality_Checklist.md](Content_Quality_Checklist.md) — 給C的內容品質檢查表，跨系列通用，任何新系列開工前必讀（2026-07-12從Desktop散檔搬進來集中管理）
