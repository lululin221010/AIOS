...
5. **ST 商城 Phase 5：First Purchasable Product（第一個可購買版本）**——不要叫「Checkout Pipeline」或「UI」這種技術命名，這階段的目標是讓一位真實使用者能完整走過「選購→付款→取得電子書→開始閱讀」。範圍：
   - ① Checkout UI：商品頁 → 加入購物車 → Checkout → 付款 → 成功，第一個真正的購物流程 Demo
     - **購買前提醒文案（2026-07-06妹補充，數位商品的使用者教育，屬UX不是技術功能）**：確認訂單頁面加一段「📖 數位商品購買提醒」——「購買完成後，請保留本次訂單資訊（或將訂單頁加入書籤）。未來您購買的電子書、課程、有聲書、模板、AI工具及其他數位商品，都會透過「我的商品」與訂單紀錄提供存取。如需重新閱讀、下載或使用商品，請登入您的帳號並透過訂單紀錄進入。」
   - ② Payment Result Pages：Success / Failed / Pending，顯示訂單號、付款資訊、回首頁、查看訂單
     - **付款成功頁提醒文案**：「✅ 購買成功！您的商品已加入「我的商品」。建議您保留本次訂單資訊，日後可透過我的商品／我的訂單，隨時再次閱讀、觀看課程或使用已購買的數位商品。」再加一句強調帳號綁定（避免使用者誤以為Email是唯一憑證）：「您的購買權益會綁定於本帳號，請妥善保管登入帳號。未來所有已購買的數位商品皆可於登入後再次使用。」
     - **付款成功頁「下一步」卡片**：①📚前往我的商品（主要按鈕）②📄查看訂單③✉️重新寄送訂單通知（**未來可做，非Phase5必須**）④🏠回首頁——目的是讓使用者第一次購買後就知道「以後東西都在我的商品」，降低日後「我買的電子書在哪裡」「課程怎麼重新看」這類客服問題
   - ③ 我的訂單頁
